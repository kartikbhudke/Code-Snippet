...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="ls s-pt-80 s-pb-50 s-pt-lg-120 s-pb-lg-90 s-pt-xl-160 s-pb-xl-130 c-mb-30 team-page">
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="vertical-item rounded rounded-image-top hero-bg content-padding text-center">
								<div class="item-media">
									...
									<p class="social-icons content-hover">
										...
										<a href="#" class="fa fa-youtube-play bg-icon rounded-icon" title="google"></a>
									</p>
								</div>
			...
			<!-- <section class="s-pt-75 s-pb-60 s-pb-md-80 s-py-lg-120 s-pt-xl-155 s-pb-xl-160 ls ms" id="testimonials" id="blog">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
