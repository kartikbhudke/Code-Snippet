...
<html class="no-js">
<head>
	<title>Stetig | Salesforce Consulting | Hiring</title>
	<meta charset="utf-8">	
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 animate" data-animation="scaleAppear">
								...
								<input  id="number" maxlength="80" name="number" size="13" type="number" /><br>

								<label for="email">Email</label>
								<input  id="email" maxlength="80" name="email" size="20" type="text" /><br>

								<label for="subject">Subject</label>
								<input  id="subject" maxlength="40" name="subject" size="30" type="text" /><br>

								<label for="description">Message</label>
								<textarea name="description"></textarea><br>
								
								<!-- <label for="company">Category</label> -->
								<input type=hidden value="Hiring" id="00N4p00000G96lJ" name="00N4p00000G96lJ" title="Category">

								<!-- <select  id="00N4p00000G96lJ" name="00N4p00000G96lJ" title="Category">
								...
								<input type="submit" name="submit" class="btn btn-maincolor submitButton">
						...
						<div class="col-lg-4 animate" data-animation="scaleAppear">
							...
							<p class="icon-inline">
								...
								<span>Kumar Vastu, Range Hills Road, Pune</span>
							</p>
